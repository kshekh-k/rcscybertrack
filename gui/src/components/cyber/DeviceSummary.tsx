    ...
    <div className="bg-surface rounded-xl p-5 shadow-lg flex flex-col justify-between">
      <div>
        ...
        <div className="grid grid-cols-4 gap-2 mb-4 text-center">
          <div className="bg-app-bg/60 /80 rounded-lg p-2">
            <p className="text-3xs text-text-muted uppercase tracking-wider font-semibold">Total</p>
          ...
          <div className="bg-emerald-950/20 rounded-lg p-2">
            <p className="text-3xs text-emerald-400 uppercase tracking-wider font-semibold">Online</p>
            <p className="text-base font-semibold font-mono text-emerald-400 mt-0.5">{onlineCount}</p>
          </div>
          <div className="bg-rose-950/20 rounded-lg p-2">
            <p className="text-3xs text-rose-400 uppercase tracking-wider font-semibold">Offline</p>
          ...
          <div className="bg-amber-950/20 rounded-lg p-2">
            <p className="text-3xs text-amber-400 uppercase tracking-wider font-semibold">Degraded</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-3xs bg-slate-800 text-slate-400 px-1.5 py-0.2 rounded capitalize font-mono">
                      {device.device_type}
                    </span>
                  </div>
