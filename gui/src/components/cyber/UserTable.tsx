...
export const UserTable: React.FC<UserTableProps> = ({
  ...
  return (
    <div className="bg-surface rounded-xl overflow-hidden shadow-lg space-y-0">
                ...
                >
                  ...
                  <td className="py-4 px-6 font-semibold text-text-primary">
                    <div className="flex items-center gap-3">
                      <div className="size-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 font-mono text-xs shrink-0">
                        {u.username.substring(0, 2).toUpperCase()}
                      </div>
                      <div>
                        <p className="font-mono text-text-primary">{u.username}</p>
                        <p className="text-2xs text-text-muted font-sans font-normal">{u.full_name}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="py-4 px-6">
                    {u.mfa_enabled ? (
                      ...
                      <span className="text-2xs font-mono text-slate-500">Disabled</span>
                    )}
                  </td>

                  {/* Created / Last Login */}
                  <td className="py-4 px-6 font-mono text-2xs text-text-muted">
